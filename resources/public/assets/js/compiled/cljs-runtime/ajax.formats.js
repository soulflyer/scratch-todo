...
var G__61556 = request;
var G__61557 = cljs.core.second(format_entry);
return (ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2 ? ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2(G__61556,G__61557) : ajax.formats.get_format.call(null,G__61556,G__61557));
} else {
...
return cljs.core.some((function (p1__61561_SHARP_){
return ajax.formats.content_type_matches(content_type,p1__61561_SHARP_);
}),accept);
});
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__61565){
...
var request = map__61566__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61566__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__61570 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__61570.cljs$core$IFn$_invoke$arity$1 ? fexpr__61570.cljs$core$IFn$_invoke$arity$1(response) : fexpr__61570.call(null,response));
});
});
ajax.formats.accept_header = (function ajax$formats$accept_header(p__61573){
...
var request = map__61574__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__61574__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
return cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__61571_SHARP_){
return ajax.formats.get_accept_entries(request,p1__61571_SHARP_);
