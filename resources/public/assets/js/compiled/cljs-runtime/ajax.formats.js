...
var G__76612 = request;
var G__76613 = cljs.core.second(format_entry);
return (ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2 ? ajax.formats.get_format.cljs$core$IFn$_invoke$arity$2(G__76612,G__76613) : ajax.formats.get_format.call(null,G__76612,G__76613));
} else {
...
return cljs.core.some((function (p1__76618_SHARP_){
return ajax.formats.content_type_matches(content_type,p1__76618_SHARP_);
}),accept);
});
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__76620){
var map__76621 = p__76620;
var map__76621__$1 = (((((!((map__76621 == null))))?(((((map__76621.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__76621.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__76621):map__76621);
var request = map__76621__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76621__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__76627 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__76627.cljs$core$IFn$_invoke$arity$1 ? fexpr__76627.cljs$core$IFn$_invoke$arity$1(response) : fexpr__76627.call(null,response));
});
});
ajax.formats.accept_header = (function ajax$formats$accept_header(p__76630){
var map__76631 = p__76630;
var map__76631__$1 = (((((!((map__76631 == null))))?(((((map__76631.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__76631.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__76631):map__76631);
var request = map__76631__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76631__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
return cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__76629_SHARP_){
return ajax.formats.get_accept_entries(request,p1__76629_SHARP_);
