...
var G__64952 = devtools.prefs.pref(v);
v = G__64952;
continue;
} else {
return v;
...
}catch (e64906){var _e__63849__auto__ = e64906;
return false;
}})();
...
}catch (e64915){var _e__63849__auto__ = e64915;
return false;
}})();
...
}catch (e64917){var _e__63849__auto__ = e64917;
return false;
}}
}
});
...
var vec__64933 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64933,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__64933,(1),null);
...
return cljs.core.some((function (p1__64938_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__64938_SHARP_);
}),template);
});
