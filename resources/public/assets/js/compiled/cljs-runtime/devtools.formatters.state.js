...
var len__4736__auto___64725 = arguments.length;
var i__4737__auto___64726 = (0);
while(true){
if((i__4737__auto___64726 < len__4736__auto___64725)){
args__4742__auto__.push((arguments[i__4737__auto___64726]));

var G__64728 = (i__4737__auto___64726 + (1));
i__4737__auto___64726 = G__64728;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq64669){
var G__64670 = cljs.core.first(seq64669);
var seq64669__$1 = cljs.core.next(seq64669);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__64670,seq64669__$1);
}));
...
return cljs.core.some((function (p1__64686_SHARP_){
return (p1__64686_SHARP_ === object);
}),history);
});
