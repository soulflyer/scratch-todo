...
ajax.url.key_value_pair_to_str = (function ajax$url$key_value_pair_to_str(p__75997){
var vec__75998 = p__75997;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75998,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75998,(1),null);
...
var vec_key_encode = (function (){var G__76011 = (function (){var or__4126__auto__ = vec_strategy;
...
var G__76011__$1 = (((G__76011 instanceof cljs.core.Keyword))?G__76011.fqn:null);
switch (G__76011__$1) {
case "java":
return (function (k){
return null;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__76011__$1)].join('')));
 ...
 */
ajax.url.param_to_key_value_pairs = (function ajax$url$param_to_key_value_pairs(vec_key_transform,prefix,p__76021){
var vec__76022 = p__76021;
var key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__76022,(0),null);
var value = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__76022,(1),null);
...
(ajax.url.url_request_format.cljs$core$IFn$_invoke$arity$1 = (function (p__76039){
var map__76040 = p__76039;
var map__76040__$1 = (((((!((map__76040 == null))))?(((((map__76040.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__76040.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__76040):map__76040);
var vec_strategy = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__76040__$1,new cljs.core.Keyword(null,"vec-strategy","vec-strategy",1843221372));
