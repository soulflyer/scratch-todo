...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq64967){
var G__64968 = cljs.core.first(seq64967);
var seq64967__$1 = cljs.core.next(seq64967);
var G__64969 = cljs.core.first(seq64967__$1);
var seq64967__$2 = cljs.core.next(seq64967__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__64968,G__64969,seq64967__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__64986_SHARP_){
return (!((cljs.core.meta(p1__64986_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__64994__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e64998){var _e__63849__auto__ = e64998;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e65000){var _e__63849__auto__ = e65000;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__65002 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__65003 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__65003);

try{var map__65005 = opts;
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__65005__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__65002);
}});
...
var temp__5751__auto___65027 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5751__auto___65027)){
var managed_print_level_65028 = temp__5751__auto___65027;
var _STAR_print_level_STAR__orig_val__65010_65029 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__65011_65030 = managed_print_level_65028;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__65011_65030);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__65007_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__65007_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__65010_65029);
}} else {
job_fn();
}
