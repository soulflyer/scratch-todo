...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_66688 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_66688(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_66690 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_66690(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_66695 = (function (reader,ch){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_66695(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_66696 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_66696(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_66705 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_66705(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_66708 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_66708(reader);
}
});
...
var G__66776 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__66777 = s.append(c);
c = G__66776;
s = G__66777;
continue;
}
