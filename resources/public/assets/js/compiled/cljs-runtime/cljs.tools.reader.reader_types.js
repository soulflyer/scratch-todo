...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_64667 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_64667(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_64676 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_64676(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_64679 = (function (reader,ch){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_64679(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_64680 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_64680(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_64683 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_64683(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_64691 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_64691(reader);
}
});
...
var G__64754 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__64755 = s.append(c);
c = G__64754;
s = G__64755;
continue;
}
