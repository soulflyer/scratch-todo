...
var map__62370 = top_item;
var map__62370__$1 = (((((!((map__62370 == null))))?(((((map__62370.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__62370.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__62370):map__62370);
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62370__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62370__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__62370__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error(error.message,file,line,column);
}catch (e62369){var _e = e62369;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5751__auto___62406 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5751__auto___62406)){
var seen_errors_62407 = temp__5751__auto___62406;
if(cljs.core.truth_(seen_errors_62407.has(self))){
} else {
seen_errors_62407.add(self);

var temp__5753__auto___62410 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5753__auto___62410)){
var sense_62411 = temp__5753__auto___62410;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_62411)].join(''));
} else {
}
}
} else {
