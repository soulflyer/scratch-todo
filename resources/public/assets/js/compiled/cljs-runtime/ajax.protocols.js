...
var ajax$protocols$AjaxImpl$_js_ajax_request$dyn_75980 = (function (this$,request,handler){
...
return ajax$protocols$AjaxImpl$_js_ajax_request$dyn_75980(this$,request,handler);
}
});
...
var ajax$protocols$AjaxRequest$_abort$dyn_75985 = (function (this$){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxRequest$_abort$dyn_75985(this$);
}
});
...
var ajax$protocols$AjaxResponse$_status$dyn_75986 = (function (this$){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_status$dyn_75986(this$);
}
});

var ajax$protocols$AjaxResponse$_status_text$dyn_75987 = (function (this$){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_status_text$dyn_75987(this$);
}
});

var ajax$protocols$AjaxResponse$_get_all_headers$dyn_75991 = (function (this$){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_get_all_headers$dyn_75991(this$);
}
});

var ajax$protocols$AjaxResponse$_body$dyn_75992 = (function (this$){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_body$dyn_75992(this$);
}
});

var ajax$protocols$AjaxResponse$_get_response_header$dyn_75996 = (function (this$,header){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_get_response_header$dyn_75996(this$,header);
}
});

var ajax$protocols$AjaxResponse$_was_aborted$dyn_76008 = (function (this$){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$AjaxResponse$_was_aborted$dyn_76008(this$);
}
});
...
var ajax$protocols$Interceptor$_process_request$dyn_76016 = (function (this$,request){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$Interceptor$_process_request$dyn_76016(this$,request);
}
});

var ajax$protocols$Interceptor$_process_response$dyn_76020 = (function (this$,response){
var x__4428__auto__ = (((this$ == null))?null:this$);
...
return ajax$protocols$Interceptor$_process_response$dyn_76020(this$,response);
}
});
...
(ajax.protocols.Response.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4382__auto__,k75925,else__4383__auto__){
var self__ = this;
var this__4382__auto____$1 = this;
var G__75948 = k75925;
var G__75948__$1 = (((G__75948 instanceof cljs.core.Keyword))?G__75948.fqn:null);
switch (G__75948__$1) {
case "status":
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k75925,else__4383__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4402__auto__,p__75952){
var vec__75953 = p__75952;
var k__4403__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75953,(0),null);
var v__4404__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__75953,(1),null);
...
(ajax.protocols.Response.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this75926,other75927){
var self__ = this;
var this75926__$1 = this;
return (((!((other75927 == null)))) && ((this75926__$1.constructor === other75927.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this75926__$1.status,other75927.status)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this75926__$1.body,other75927.body)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this75926__$1.status_text,other75927.status_text)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this75926__$1.headers,other75927.headers)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this75926__$1.was_aborted,other75927.was_aborted)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this75926__$1.__extmap,other75927.__extmap)));
}));
...
(ajax.protocols.Response.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4387__auto__,k__4388__auto__,G__75924){
var self__ = this;
var this__4387__auto____$1 = this;
var pred__75974 = cljs.core.keyword_identical_QMARK_;
var expr__75975 = k__4388__auto__;
if(cljs.core.truth_((pred__75974.cljs$core$IFn$_invoke$arity$2 ? pred__75974.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"status","status",-1997798413),expr__75975) : pred__75974.call(null,new cljs.core.Keyword(null,"status","status",-1997798413),expr__75975)))){
return (new ajax.protocols.Response(G__75924,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__75974.cljs$core$IFn$_invoke$arity$2 ? pred__75974.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"body","body",-2049205669),expr__75975) : pred__75974.call(null,new cljs.core.Keyword(null,"body","body",-2049205669),expr__75975)))){
return (new ajax.protocols.Response(self__.status,G__75924,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__75974.cljs$core$IFn$_invoke$arity$2 ? pred__75974.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__75975) : pred__75974.call(null,new cljs.core.Keyword(null,"status-text","status-text",-1834235478),expr__75975)))){
return (new ajax.protocols.Response(self__.status,self__.body,G__75924,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__75974.cljs$core$IFn$_invoke$arity$2 ? pred__75974.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"headers","headers",-835030129),expr__75975) : pred__75974.call(null,new cljs.core.Keyword(null,"headers","headers",-835030129),expr__75975)))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,G__75924,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__75974.cljs$core$IFn$_invoke$arity$2 ? pred__75974.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__75975) : pred__75974.call(null,new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828),expr__75975)))){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,G__75924,self__.__meta,self__.__extmap,null));
} else {
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4388__auto__,G__75924),null));
}
}
}
}
...
(ajax.protocols.Response.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4379__auto__,G__75924){
var self__ = this;
var this__4379__auto____$1 = this;
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,G__75924,self__.__extmap,self__.__hash));
}));
 ...
 */
ajax.protocols.map__GT_Response = (function ajax$protocols$map__GT_Response(G__75932){
var extmap__4419__auto__ = (function (){var G__75979 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__75932,new cljs.core.Keyword(null,"status","status",-1997798413),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], 0));
if(cljs.core.record_QMARK_(G__75932)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__75979);
} else {
return G__75979;
}
})();
return (new ajax.protocols.Response(new cljs.core.Keyword(null,"status","status",-1997798413).cljs$core$IFn$_invoke$arity$1(G__75932),new cljs.core.Keyword(null,"body","body",-2049205669).cljs$core$IFn$_invoke$arity$1(G__75932),new cljs.core.Keyword(null,"status-text","status-text",-1834235478).cljs$core$IFn$_invoke$arity$1(G__75932),new cljs.core.Keyword(null,"headers","headers",-835030129).cljs$core$IFn$_invoke$arity$1(G__75932),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828).cljs$core$IFn$_invoke$arity$1(G__75932),null,cljs.core.not_empty(extmap__4419__auto__),null));
});
